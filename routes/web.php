...
Route::middleware(['auth'])->group(function(){
    ...
    Route::controller(PermissionController::class)->group(function(){
        Route::get('permissions/index', 'index')->name('permissionsIndex')->middleware('permission:permission-read');
        Route::get('permissions/create', 'create')->name('permissionsCreate')->middleware('permission:permission-create');
        Route::post('permissions/store', 'store')->name('permissionsStore')->middleware('permission:permission-create');
    ...
    Route::controller(ProfileController::class)->group(function(){
        ...
        Route::post('profile/update/{id}', 'index')->name('profileUpdate')->middleware('permission:profile-update');
    });
