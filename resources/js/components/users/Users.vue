    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header bg-dark">
          ...
          <button class="btn btn-success float-end" @click="createUser" v-if="current_permissions.has('users-create')">
            New User
          </button>
        </div>
        <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <div class="text-danger" v-if="userData.errors.has('name')" v-html="userData.errors.get('name')">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <multi-select :options="filtered_departments" v-model="userData.department_id"
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <multi-select :options="filtered_roles" v-model="userData.selected_roles" :searchable="true"
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <multi-select :options="filtered_permission_categories"
                          v-model="userData.selected_permission_categories" :searchable="true" mode="tags"
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <multi-select :options="filtered_permissions" v-model="userData.selected_permissions"
