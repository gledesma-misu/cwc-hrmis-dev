      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              ...
              <div v-for="(comment, index) in comments" :key="index">
                <div class="d-flex justify-content-between">
                  ...
                  <div class="comment-icons">
                    <i
                      class="fa fa-edit text-success comment-icon"
                      v-if="
                        current_permissions.has('comments-update') &&
                    ...
                    <i
                      class="fa fa-trash text-danger comment-icon"
                      v-if="
                        current_permissions.has('comments-delete') &&
                        current_user.id === comment.user_id
                      "
          ...
          <div class="d-flex justify-content-between">
            ...
            <button type="button" :class="`btn ${!editMode ? 'btn-success' : 'btn-warning'}`" @click="!editMode ? storeComment() : updateComment()">
